...
<div class="widget-head-title"> 
                              <span class="head-bg"><img src="<?php echo $imagePath?>/images/ic-giving.png" alt="Image" class=""/></span>
                               <div class="widget-head-contents clearfix">
                                   <h2>Giving</h2>
                                   <p class="sub-head"><?php print $title; ?></p>
                               </div>
                               <br/> 
</div>
...
<?php $field_name = 'field_giving_download_pdf';
        $field= field_get_items('node', $node, $field_name); 
        if( $field[0]['value']) {?>
