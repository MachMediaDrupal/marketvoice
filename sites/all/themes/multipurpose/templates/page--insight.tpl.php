...
<section class="content-wrapper articles" id="wrap" >
 <div class="row">
    <div class="container clearfix" id= "main">
       <div id="top"></div>
            <div class="col-md-lt widget-area-txt"> <?php print render($page['content']); ?><a href="#top" style="float:right" class="back-to-top">Navigate to Top <strong>&uarr;</strong></a> </div>
