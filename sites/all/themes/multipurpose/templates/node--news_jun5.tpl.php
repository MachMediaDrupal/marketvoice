...
<?php $field_name = 'field_add_text_right_sidebar1';
    ...
    <div class="clearfix"><p> <?php 
        $field_name = 'field_bottom_side_bar';
        $field= field_get_items('node', $node, $field_name);
        print $field[0]['value']; ?> </p> 
    </div>
<?php 
...
{
switch($node->nid){
case 41: $name = "CFTC Rountable on Cybersecurity.mp4";
break;
case 37: $name= "Jonathan Hill.mp4" ;break;
default: $name='';break;
}
	if($name!="")
{?>
 <div class="video-player">
	<video width="100%" controls>
	    <source src="<?php echo $base_url.'/'. variable_get('file_public_path', conf_path() . '/files/').$name?>" type="video/mp4">Your browser does not support HTML5 video.
	</video>
