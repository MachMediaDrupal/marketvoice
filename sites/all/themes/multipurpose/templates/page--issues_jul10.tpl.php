...
<?php
    ...
    $cookie_value = 0;
    $cookie_name_first = "firstcookie";   
?>
<html>
<body>
<a  id="register_first"  data-toggle="modal" data-target="#myModalFirstPage"  style="display:none">ss</a>
<div class="modal fade" id="myModalFirstPage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
if((!isset($user->name)) && !isset($_COOKIE[$cookie_name_first])){
