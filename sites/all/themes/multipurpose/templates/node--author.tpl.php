 ...
 */
 ...
 global $base_url;
require_once("RelatedAuthor.php");
?>
<?php if (!$page): ?>
...
<?php
          $align = '';
        $field_name = 'field_align_author_image';
        $field= field_get_items('node', $node, $field_name); 
        $align = $field[0]['value'];
       
        $field_name = 'field_author_image';
        $field= field_get_items('node', $node, $field_name); 
        $image_name = $field[0]['filename']; 
        $image = "<img src = '$base_url/sites/default/files/$image_name' width = '155' height = '143' 
   style='padding: 5px;
    border: 1px solid #ccc;'> </img>";



        if( $align == "Left" ||  $align == "None"){?><figure>
        <?php echo $image;?> </figure><?php } 
       if( $align == "Right"){?><figure class = "image-right">
        <?php echo $image;?> </figure><?php } ?>
           <div class="author-descpin"><?php 
               ...
               <div class="clearfix"><?php 
                   ...
                   $query = getRelatedAuthor($node->nid);
                   $leftli = ''; $rightli = "";
                   $i = 0;
