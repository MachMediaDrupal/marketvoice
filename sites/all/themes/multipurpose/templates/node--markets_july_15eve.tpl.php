...
<?php $author = '';
        $field_name = 'field_markets_add_author';
...
<?php if($author) {?><span class="author"> <?php echo "By ". rtrim($author, ", "); ?> </span> <?php }?>
 ...
 <?php $field_name = 'field_markets_sub_title';
        $field= field_get_items('node', $node, $field_name); 
        if( $field[0]['value']) {?>
                        <span class="subtitle">
<?php print $field[0]['value']?></span><?php }?></h2>

<?php $field_name = 'field_markets_deck_text';
        $field= field_get_items('node', $node, $field_name); 
        if( $field[0]['value']) {?>
...
<div class="widget-area-txt">
    ...
    <div class="widget-contents clearfix"><?php 
        $field_name = 'field_markets_left_sidebar';
        $field= field_get_items('node', $node, $field_name); 
        if( $field[0]['value']) {?>
            ...
            <?php 
                $field_name = 'field_markets_right_sidebar';
                $field= field_get_items('node', $node, $field_name);
                print $field[0]['value'];?> 
            <?php 
        }?>
...
<?php /*Added sidebar*/?>
<?php $field_name = 'field_markets_text_bar';
        $field= field_get_items('node', $node, $field_name); 
        if( $field[0]['value']) {?>
...
<?php $field_name = 'field_markets_text_bar_head';
        $field= field_get_items('node', $node, $field_name); 
        if( $field[0]['value']) {?>
                                <div class="secodary-head">
<h6><?php print $field[0]['value'];?></h6>
<?php 
$field_name = 'field_markets_text_bar_small_hea';
        $field= field_get_items('node', $node, $field_name); 
        if( $field[0]['value']) {
                                    print $field[0]['value'];}?>
                                </div>
...
<?php $field_name = 'field_markets_right_text_bar';
        $field= field_get_items('node', $node, $field_name); 
...
<div class="widget-contents clearfix"> 
<?php /*Added sidebar*/?>
<?php $field_name = 'field_markets_text_bar1';
        $field= field_get_items('node', $node, $field_name); 
        if( $field[0]['value']) {?>
                              ...
                              <div class="content-container-aside">
                                   <div class="widget-business-story align-left width-small">
                                  <h3><?php print $field[0]['value'];?></h3>
<?php $field_name = 'field_markets_text_bar_head1';
        $field= field_get_items('node', $node, $field_name); 
        if( $field[0]['value']) { ?>
                                <div class="secodary-head">
 <h6><?php print $field[0]['value'];?></h6>
                                  <?php $field_name = 'field_markets_text_bar1_small_he';
        $field= field_get_items('node', $node, $field_name); 
        if( $field[0]['value']) { print $field[0]['value'];}?>
                                </div>
<?php }?></div></div>
             ...
             <?php }?>
<?php $field_name = 'field_markets_right_text_bar1';
        $field= field_get_items('node', $node, $field_name); 
        if( $field[0]['value']) { print $field[0]['value'];}?>
</div>
    ...
    <div class="clearfix"><p> <?php 
        $field_name = 'field_markets_after_text_bar';
        $field= field_get_items('node', $node, $field_name);
