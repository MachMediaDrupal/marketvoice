...
<div class="advertisement-blk">
    <img src="<?php echo $imagePath; ?>/images/ad_728x180.jpg" alt="image">
</div>
    ...
    <div class="widget-main-story">
        ...
        <div class="list-story clearfix"><?php 
            foreach($formtype as $itemid) {  
                ...
                <figure>
                    <img src="<?php echo $base_url.'/sites/default/files/'.$item->field_top_story['und'][0]['entity']->field_thumbnail['und'][0]['filename'];?>" width="83" height="83"/>
                </figure> 

		<figcaption>
		    <h6><?php echo $item->field_top_story['und'][0]['entity']->title; ?></h6>
                    <p> <?php
                        if($item->field_top_story['und'][0]['entity']->body['und'][0]['summary']) 
                        ...
                        <span>By <?php echo  $item->field_top_story['und'][0]['entity']->field_author['und'][0]['value'] ?></span>
                    </p>
...
<img src="<?php echo $base_url.'/sites/default/files/'.$item->field_featured_news['und'][0]['entity']->field_thumbnail['und'][0]['filename'];?>" width="83" height="83"/><?php }?> </figure>
                         <figcaption>
                            ...
                            <p> <?php
                        if($item->field_featured_news['und'][0]['entity']->body['und'][0]['summary']) 
...
<?php  if(isset($item->field_author['und'][0]['value'])){?>
                        <span>By <?php echo  $item->field_featured_news['und'][0]['entity']->field_author['und'][0]['value'] ?></span><?php }?></p>
                                   <a href="#" class="readmore">Read more</a>
                                    </figcaption>
                                </div>
                                </li>
